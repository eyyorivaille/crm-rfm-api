"""Pipeline ve notebooklar arasinda paylasilan MLflow yardimcilari.

Sadece egitim/pipeline tarafinda kullanilir - FastAPI uygulamasinin
...
def promote_if_better(client, model_name, new_version, metric_key, higher_is_better=True):
    ...
    (bkz. pipeline/segmentation.py - orada bu fonksiyon bilerek kullanilmiyor).
    """
